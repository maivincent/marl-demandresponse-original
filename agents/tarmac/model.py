...
class CommAttention(nn.Module):
    def __init__(self, state_size=128, comm_size=32, key_size=16, num_hops=3):
        ...
        self.msg2nextstate = nn.Sequential(
            nn.Linear(state_size + comm_size, state_size), nn.LeakyReLU())
...
class MultiAgentBase(nn.Module):
    def __init__(self,
        ...
        self.common = nn.Sequential(
            nn.Linear(obs_size + comm_size, state_size), nn.LeakyReLU(), nn.Linear(state_size, state_size))
        ...
        self.critic = nn.Sequential(
            ...
            MeanAll(dim=1, keepdim=False), nn.LeakyReLU(), nn.Linear(state_size, 1))
